import { getApiBaseUrl } from '../../services/axiosInstance';
...
export function getImageUrl(imagePath) {
    ...
    const imgPrefix = import.meta.env.VITE_IMG_PREFIX || 'publications_service/'
    ...
    // En desarrollo, usamos '' (vacío) porque el proxy de Vite redirige /publications_service a localhost:8888
    // En producción, usamos la URL de producción (o el origen local si estamos en localhost)
