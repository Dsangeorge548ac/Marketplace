...
const hasNumericPrice = computed(() => {
  const parsed = Number(props.selectedHarvest?.price)
        ...
        <div class="product-details">
          ...
          <div class="price-section">
            <div class="price-container">
              <span class="currency" v-if="hasNumericPrice">$</span>
              <span class="price">{{ formattedPrice }}</span>
            </div>
            <div class="price-details">
              <div class="total-price">
                <span>Valor total con Impuestos: </span>
                <span class="total-amount">{{ hasNumericPrice ? `$${totalWithTax}` : totalWithTax }}</span>
              </div>
            </div>
          </div>
